    ...
    <main className="min-h-screen ">
      <section className="flex flex-col bg-bgGreen h-80 w-full mb-8">
        <div className="flex flex-col gap-4 h-full cursor-default justify-center items-center">
          <h1 className="text-5xl font-bold text-white">Welcome to Omakoju</h1>
          <div className="text-white flex font-semibold">The place to find the best&nbsp;<p className="text-bgBeige font-bold">shops</p>&nbsp;and&nbsp;<p className="text-bgBeige font-bold">customers</p></div>
        </div>
      </section>
